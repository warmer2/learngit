...
<head>
	...
	<style type="text/css">
		body { background: url(../img/bg-login.png) !important;}
	</style>
				...
				<div class="login-box">
					...
					<form class="form-horizontal" action="doLogin.php" method="post">
						<fieldset>
                            ...
                            <div class="input-tag">
                            	<span class="show-tag">验证码：</span>
                                <div class="input-prepend2" title="">
                                	<input class="input-answer" name="verify" id="verify" type="text"/>								
                                    <img src="getVerify.php" onClick="this.src='getVerify.php?nocache='+Math.random()" alt="点击换一张" />
                                    <!-- onclick单击更新验证码 -->
                                </div>
                            </div>
